            ...
            <#if permissions?seq_contains("10")>
                <div title="营销管理" data-options="selected:true,iconCls:'icon-yxgl'" style="padding: 10px">
                    <#if permissions?seq_contains("1010")>
                        <a href="javascript:openTab('营销机会管理','saleChance/index','icon-yxjhgl')"
                    ...
                    <#if permissions?seq_contains("1020")>
                        <a href="javascript:openTab('客户开发计划','saleChance/index?state=1','icon-khkfjh')"
                ...
                <div title="客户管理" data-options="iconCls:'icon-khgl'" style="padding:10px;">
                    <#if permissions?seq_contains("2010")>
                        <a href="javascript:openTab('客户信息管理','customer/index','icon-khxxgl')" class="easyui-linkbutton"
                           data-options="plain:true,iconCls:'icon-khxxgl'" style="width: 150px;">客户信息管理</a></#if>
                    <#if permissions?seq_contains("2020")>
                        <a href="javascript:openTab('客户流失管理','customerLoss/index','icon-khlsgl')"
                           class="easyui-linkbutton"
                           data-options="plain:true,iconCls:'icon-khlsgl'" style="width: 150px;">客户流失管理</a></#if>
                </div>
            </#if>
        </#if>
        <#if permissions??>
...
<div id="dlg" class="easyui-dialog" style="width:400px;height:250px;padding: 10px 20px"
    ...
    <form id="fm" method="post">
        <table cellspacing="8px">
            ...
            <tr>
                <td>原密码：</td>
                <td><input type="password" id="oldPassword" name="oldPwd" class="easyui-validatebox" required="true"
                           style="width: 200px"/></td>
            </tr>
            <tr>
                <td>新密码：</td>
                <td><input type="password" id="newPassword" name="newPwd" class="easyui-validatebox" required="true"
                           style="width: 200px"/></td>
            </tr>
            <tr>
                <td>确认新密码：</td>
                <td><input type="password" id="newPassword2" name="confirmPwd" class="easyui-validatebox"
