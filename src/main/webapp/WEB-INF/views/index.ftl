...
<div class="logo">
	<a href="index.html">
	<img src="${ctx}/images/bglogo.png" alt=""/>
...
<div class="content">
	...
	<form class="login-form" action="index.html" method="post">
		...
		<div class="form-group">
			...
			<input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="用户名" id="userName" name="username" value="fkun"/>
		</div>
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">密码</label>
			<input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="密码" id="userPwd" name="password" value="123456"/>
		</div>
		<div class="form-actions">
			<button id="btnOK" type="button" class="btn btn-success uppercase btn-xs btn-block" onclick="login()">登录</button>
		</div>
...
<!-- END JAVASCRIPTS -->
<link href="${ctx}/css/jquery-confirm.css" rel="stylesheet" meidia="screen">
<script src="${ctx}/jquery-easyui-1.3.3/jquery.min.js"></script>
<script src="${ctx}/js/jquery-confirm.js" type="text/javascript"></script>
